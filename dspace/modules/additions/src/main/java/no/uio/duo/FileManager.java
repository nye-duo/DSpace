...
public class FileManager
{
     ...
     */
    public Bitstream findBitstream(IncomingBitstream ib, List<Bitstream> bitstreams)
    {
     ...
     * @throws AuthorizeException
     */
    public void sequenceBitstreams(Context context, Item item, String bundleName, List<IncomingBitstream> ibs)
            throws SQLException, AuthorizeException
    {
        ...
        Map<Integer, UUID> orderMap = new TreeMap<Integer, UUID>();
        ...
        if (orderMap.size() > 0)
        {
            Map<Integer, UUID> normalisedOrder = new TreeMap<Integer, UUID>();
