...
public class CristinOREImporter implements IngestionCrosswalk, OAIConfigurableCrosswalk
{
            ...
            throws SQLException, AuthorizeException, IOException
    {
        ...
        {
            this.backupAndRemove(context, item, bitstream, deleted);

        }
    }

    private void backupAndRemove(Context context, Item item, Bitstream bitstream)
            throws SQLException, AuthorizeException, IOException
    {
        // get the backup bundle
        Bundle deleted = this.getDeletedBundle(context, item);
    ...
    private void backupAndRemove(Context context, Item item, Bitstream bitstream, Bundle backupBundle)
            throws SQLException, AuthorizeException, IOException
    {
        BundleService bundleService = ContentServiceFactory.getInstance().getBundleService();
        bundleService.addBitstream(context, backupBundle, bitstream);
    ...
    private void backupAndRemove(Context context, Item item, Bundle sourceBundle, IncomingBitstream ib)
            throws SQLException, AuthorizeException, IOException
    {
        ...
        Bundle deleted = this.getDeletedBundle(context, item);
        this.backupAndRemove(context, item, bs, deleted);
    }

    private Bundle getDeletedBundle(Context context, Item item)
            throws SQLException, AuthorizeException, IOException
    {
        ItemService itemService = ContentServiceFactory.getInstance().getItemService();
        BundleService bundleService = ContentServiceFactory.getInstance().getBundleService();

        List<Bundle> deleteds = itemService.getBundles(item, "DELETED");
        Bundle deleted = null;
        ...
        {
            deleted = bundleService.create(context, item, "DELETED");
        }
        return deleted;
    }
