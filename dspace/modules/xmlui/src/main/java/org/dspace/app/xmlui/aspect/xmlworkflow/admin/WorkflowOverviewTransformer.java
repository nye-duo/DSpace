        ...
        try {
            ...
            if (hitCount > 0) {
                ...
                for (XmlWorkflowItem wfi : results) {
                    ...
                    if (cfg != null)
                    {
                        List<MetadataValue> unitcodeDC = itemService.getMetadataByMetadataString(item, cfg);
                    ...
                    // get the authors
                    String authors = "";
                    List<MetadataValue> authorDC = itemService.getMetadataByMetadataString(item, "dc.creator.author");
