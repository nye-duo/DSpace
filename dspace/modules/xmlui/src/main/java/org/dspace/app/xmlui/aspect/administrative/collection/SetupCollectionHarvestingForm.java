...
public class SetupCollectionHarvestingForm extends AbstractDSpaceTransformer   
{
	...
	public void addBody(Body body) throws WingException, SQLException, AuthorizeException
	{
        ...
        Map<String, String> ingestOptions = HarvestingOptions.getOptions("ingest_filter");
        ...
        Map<String, String> metadataOptions = HarvestingOptions.getOptions("metadata_update");
        ...
        Map<String, String> bundleOptions = HarvestingOptions.getOptions("bundle_versioning");
        ...
        Map<String, String> workflowOptions = HarvestingOptions.getOptions("ingest_workflow");
