...
public class EditCollectionHarvestingForm extends AbstractDSpaceTransformer   
{
	...
	public void addBody(Body body) throws WingException, SQLException, AuthorizeException
	{
        ...
        settings.addItem().addContent(HarvestingOptions.getDisplayValue("ingest_filter", ingestFilterValue));

        // Add a metadata removal configuration option
        settings.addLabel(T_label_metadata_update);
        settings.addItem().addContent(HarvestingOptions.getDisplayValue("metadata_update", metadataUpdateValue));

        // Add a bundle versioning strategy option
        settings.addLabel(T_label_bundle_versioning);
        settings.addItem().addContent(HarvestingOptions.getDisplayValue("bundle_versioning", bundleVersioningValue));

        // Add an ingest workflow setup option
        settings.addLabel(T_label_ingest_workflow);
        settings.addItem().addContent(HarvestingOptions.getDisplayValue("ingest_workflow", ingestWorkflowValue));
